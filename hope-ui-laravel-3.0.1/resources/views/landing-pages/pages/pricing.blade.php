                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled pt-2">
                                <li class="mb-2"><svg width="10" height="7" class="me-2" viewBox="0 0 10 7"
                ...
                <div class="col">
                    <div class="card bg-primary">
                        <div class="card-body">
                            ...
                            <p class="border-bottom pb-4 text-white">Lorem ipsum dolor sit amet, consectetur adipiscing
                                elit.</p>
                            ...
                            <a href="#" class="btn btn-light w-100 mt-4">Get Started</a>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled pt-2">
                                ...
                                <li class="mb-2"><svg width="10" height="7" class="me-2"
