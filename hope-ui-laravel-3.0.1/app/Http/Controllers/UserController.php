...
class UserController extends Controller
{
    ...
    public function update(UserRequest $request, $id)
    {
        ...
        // Check if userProfile exists before updating
        if ($user->userProfile) {
        ...
        if (auth()->check()) {
            return redirect()->route('users.index')->withSuccess(__('message.msg_updated', ['name' => __('user')]));
        }
        
        return redirect()->back()->withSuccess(__('message.msg_updated', ['name' => 'user']));
    }        
    /**
